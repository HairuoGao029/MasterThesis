...
class DCRNNModel(object):
    def __init__(self, is_training, batch_size, scaler, adj_mx, **model_kwargs):
        ...
        num_units = int(model_kwargs.get('rnn_units'))
        ...
        cell = DCGRUCell(num_units, adj_mx, max_diffusion_step=max_diffusion_step, num_nodes=num_nodes,
                         filter_type=filter_type)
        cell_with_projection = DCGRUCell(num_units, adj_mx, max_diffusion_step=max_diffusion_step, num_nodes=num_nodes,
        ...
        with tf.variable_scope('DCRNN_SEQ'):
            ...
            outputs, final_state = rnn_decoder(labels, enc_state, decoding_cells,
